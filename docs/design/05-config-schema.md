...
- **適合試験チェック**: 保通協の出玉率基準（4号機: 400G<300% / 6000G<150% / 17500G 60〜120%、5号機: 400G<220% / 17500G 55〜120%）の近似判定。上限は完全打ち（5号機のシミュレーション試験「獲得最大優先」相当）、下限は適当打ちの独立試行ウィンドウで測る教材機能。実試験手続きの再現ではない
